class Siggen extends pObject {
    constructor(pX,pY,pNo) {
        ...
        this.b_phalf=new PushButton(ctx,pX-20,pY4-16,27,18,"Pos+","on");
        this.b_phalf.setInitChannelsNeeded();
        this.b_nhalf=new PushButton(ctx,pX-20,pY4+4,27,18,"Neg-","on");
        this.b_nhalf.setInitChannelsNeeded();
        this.b_inv=new PushButton(ctx,pX+42,pY4-16,27,18,"Inv","on");
        this.b_inv.setInitChannelsNeeded();
        this.b_abs=new PushButton(ctx,pX+42,pY4+4,27,18,"Abs","on");
